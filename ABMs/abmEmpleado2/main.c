...
void inicializarEmpleados(eEmpleado lista[], int tam) // lista=array de empleados.
{
...
void obtenerSector(eSector sectores[], int tam, int idSector, char cadena[]) //idSector es del empleado
{
