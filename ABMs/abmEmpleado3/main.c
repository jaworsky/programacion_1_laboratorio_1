...
//
void queComidasSeComieron(eAlmuerzo a[],int tama,eEmpleado e[], int tame, eSector s[], int tams );
void cuantosEmpleadosComieronMila(eEmpleado e[],int tame,eAlmuerzo a[],int tama,eSector s[],int tams);
...
int main()
{
    ...
    do
    {
        ...
        case 11:
            ...
            break;
        case 12:
            queComidasSeComieron(almuerzos,20,empleados,TAM,sectores,5);
            break;
        case 13:
            cuantosEmpleadosComieronMila(empleados,TAM,almuerzos,20,sectores,5);
...
int menu()
{
    ...
    printf(" 12- Que comidas se comieron mas?\n");
    printf(" 13- Quienes comieron milanesa?\n");
    printf(" 20- Salir\n\n");
...
void altaAlmuerzo(eAlmuerzo a[], int tama, eComida c[], int tamc, eEmpleado e[], int tame, eSector s[], int tams, int* pId)
{
    int idAlmuerzo = *pId; // puntero para que pueda autoincrementar el ID
    int legajo;
    int idComida;
    efecha fecha;
    ...
    {
        nuevoAlmuerzo.id = idAlmuerzo; // igual al pID
...
void mostrarAlmuerzo(eAlmuerzo unAlmuerzo, eComida c[], int tamc, eEmpleado e[], int tame)
{
    ...
    obtenerDescComida(c, tamc, unAlmuerzo.idComida, descComida); // mismo paso que mostrar desc del sector
    indice = buscarEmpleado(e, tame, unAlmuerzo.idEmp); // UNALMUERZO.IDEMP TIENE GUARDADO EL LEGAJO DEL EMPLEADO
...
void queComidasSeComieron(eAlmuerzo a[],int tama,eEmpleado e[], int tame, eSector s[], int tams ) //prueba funcion mia
{
...
for(int i=0;i<tama;i++)
{
    ...
    switch(a[i].idComida)
    {
        ...
        break;
        case 2:
        acumPizza=acumPizza+1;
        break;
        case 3:
        acumEnsalada=acumEnsalada+1;
        break;
        case 4:
        acumPescado=acumPescado+1;
        break;
        case 5:
        acumLasagna=acumLasagna+1;
        break;
    }
...
printf("Se comieron %d Milanesas %d pizzas %d ensaladas %d pescado %d lasagnas\n",acumMilanesa,acumPizza,acumEnsalada,acumPescado,acumLasagna);
system("pause");


}
// cuantos empleados comieron milanesa
void cuantosEmpleadosComieronMila(eEmpleado e[],int tame,eAlmuerzo a[],int tama,eSector s[],int tams)
{
    ...
    printf("empleados q comieron milanesa: \n");
