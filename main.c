...
//
void clientesQueNoAlquilan(eAlquileres arrayDeAlquileres[], int tama,eClientes arrayDeClientes[],int tamc,eJuegos arrayDeJuegos[],int tamj)
{
    system("cls");
    int auxCliente;

    for(int i=0;i<arrayDeAlquileres;i++)
    {
...
//
void mostrarAlquiler2 (eAlquileres alquilerAmostrar, eClientes arrayDeClientes,eJuegos arrayDeJuegos)
{
    printf("\ncodigo de alquiler: %d  codigo de juego: %d \n descripcion: %s \n codigo de cliente: %d , fecha:  %02d/%02d/%d\n  nombre: %s\n",alquilerAmostrar.codigoDeAlquiler,alquilerAmostrar.codigoDeJuego,arrayDeJuegos.descripcion,alquilerAmostrar.codigoDeCliente,alquilerAmostrar.fecha.dia,alquilerAmostrar.fecha.mes,alquilerAmostrar.fecha.anio,arrayDeClientes.nombre);
}
//
